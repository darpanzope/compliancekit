...
- **Tracking issue cadence**: issues open just-in-time. The roadmap is the long-form planning artifact; issues are the work artifacts. Status: #25-#27 closed (v1.3-v1.5), v1.5.1 patch shipped 2026-05-19 without a tracking issue (patches don't get one per convention), #38 closed (v1.6, 2026-05-20), #39 closed (v1.7, 2026-05-20), #40 closed (v1.8, 2026-05-20), #41 closed (v1.9, 2026-05-20), #42 closed (v1.10, 2026-05-21), #44 closed (v1.11, 2026-05-21). Issue numbers from the v1.11-v1.15 batch came in out of version order — the real mapping is #44=v1.11, #43=v1.12, #45=v1.13, #46=v1.14, #47=v1.15. v1.12-v1.15 (#43 + #45-#47) open; v1.16+ stay in ROADMAP table form until the current batch ships.
