...
func mkNet(name string, isDefault bool) core.Resource {
...
func mkFW(name string, direction string, disabled, openToAny bool, allowed []map[string]any) core.Resource {
	return core.Resource{
...
func mkProjectMD(name string, osLogin bool) core.Resource {
	return core.Resource{
...
func mkInstance(name string, status string, sb, vtpm, im bool, sas []map[string]any) core.Resource {
	return core.Resource{
...
func TestShieldedVM(t *testing.T) {
	cases := []struct {
		...
		{"running all on", "RUNNING", true, true, true, 1, core.StatusPass},
		{"running partial", "RUNNING", true, false, true, 1, core.StatusFail},
		{"running none", "RUNNING", false, false, false, 1, core.StatusFail},
