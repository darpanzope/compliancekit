...
var manualFirewallChecks = []manualVerifySpec{
	{id: "linux-firewall-loopback-allowed", title: "Firewall must allow loopback traffic",
		severity: compliancekit.SeverityMedium, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.4"},
	...
	{id: "linux-firewall-icmp-input-restricted", title: "ICMP INPUT must be rate-limited",
		severity: compliancekit.SeverityLow, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.5"},
	...
	{id: "linux-firewall-ipv6-rules-present", title: "IPv6 firewall rules must mirror IPv4",
		severity: compliancekit.SeverityMedium, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.7"},
	...
	{id: "linux-firewall-egress-policy-documented", title: "Egress allow-list must be documented",
		severity: compliancekit.SeverityLow, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.6"},
	...
	{id: "linux-firewall-rules-logged", title: "Firewall drops should be logged",
		severity: compliancekit.SeverityLow, soc2: []string{"CC7.2"}, iso: []string{"A.8.15"}, cis: []string{"3.4.2.8"},
	...
	{id: "linux-firewall-ssh-rate-limited", title: "SSH ingress must be rate-limited",
		severity: compliancekit.SeverityMedium, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.9"},
	...
	{id: "linux-firewall-dns-egress-restricted", title: "DNS egress must be restricted to known resolvers",
		severity: compliancekit.SeverityLow, soc2: []string{"CC6.6"}, iso: []string{"A.8.20"}, cis: []string{"3.4.2.10"},
...
func init() {
	compliancekit.Register(CheckFirewallUFWDefaultDenyOutgoing, FirewallUFWDefaultDenyOutgoing)
	compliancekit.Register(CheckFirewallSomeActive, FirewallSomeActive)
	compliancekit.Register(CheckFirewallNFTablesOnRHEL, FirewallNFTablesOnRHEL)
