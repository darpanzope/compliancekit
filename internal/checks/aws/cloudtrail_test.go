...
func mkAccount() core.Resource {
	return core.Resource{ID: "aws.account.x", Type: awscol.AccountType, Name: "x", Provider: "aws"}
}

func mkTrail(name string, logging, multi, validation bool) core.Resource {
