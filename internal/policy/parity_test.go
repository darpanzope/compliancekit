...
func bucket(id, name string, attrs map[string]any) core.Resource {
	return core.Resource{
		ID: id, Type: "aws.s3.bucket", Name: name, Provider: "aws", Attributes: attrs,
	}
}

func kmsKey(id, name, manager, spec string, rotation bool) core.Resource {
	return core.Resource{
...
func account(id, name string, policy map[string]any) core.Resource {
	return core.Resource{
...
func gcsBucket(id, name string, attrs map[string]any) core.Resource {
	return core.Resource{
		ID: id, Type: "gcp.storage.bucket", Name: name, Provider: "gcp", Attributes: attrs,
	}
}

func sqlInstance(id, name string, protected bool) core.Resource {
	return core.Resource{
...
func droplet(id, name, vpcUUID string) core.Resource {
	return core.Resource{
...
func spacesBucket(id, name, acl string) core.Resource {
	return core.Resource{
...
func doDB(id, name string, tls bool) core.Resource {
	return core.Resource{
...
func pod(id, name string, attrs map[string]any) core.Resource {
	return core.Resource{
		ID: id, Type: "k8s.pod", Name: name, Provider: "kubernetes", Attributes: attrs,
	}
}

func host(id, name string, attrs map[string]any) core.Resource {
	return core.Resource{
...
func failedResourceIDs(findings []core.Finding) []string {
